...
player1 = input("Do you want to play with a friend or computer? Type friend or computer to pick")

if player1== 'friend':
    while player_wins < 5 and player2_wins < 5:
        player1 = input("Player 1, pick your weapon: ")
        player2 = input("Player 2, pick your weapon: ")
    ...
    if player_wins > player2_wins:  
        print(f"FINAL SCORE: Player Score: {player_wins} player2 score{player2_wins}")
